...
# Boost tab size
c.fonts.tabs.selected = "11pt"
c.tabs.padding = {"bottom": 10, "left": 5, "right": 5, "top": 10}

# Default page
c.url.start_pages = ["https://wiki.archlinux.org/title/Main_page", "https://docs.qtile.org/en/latest/index.html", "https://qutebrowser.org/doc/help/"]
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/vmuser/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/vmuser/.local/share/qutebrowser/userscripts/*')
